...
import com.example.bookhub.Utill.constant.compressPdf
...
class Upload_Book : AppCompatActivity() {
    ...
    private fun customImageSelectorDialog() {
            ...
            val binding: SelectImageBinding = SelectImageBinding.inflate(layoutInflater)
        ...
        override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
            ...
            if (resultCode== Activity.RESULT_OK){
                ...
                if(requestCode== PDF)
                {
                    ...
                    binding.discription.setText(Pdf_bytedata.toString())
                    Toast.makeText(this, Pdf_bytedata.toString(), Toast.LENGTH_SHORT).show()
                }
